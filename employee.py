...
class employeeClass:
    def __init__(self,root):
        ...
        #=====options====
        cmb_search=ttk.Combobox(SearchFrame,textvariable=self.var_searchby,values=("Select","Email","Name","Contact"),state='readonly',justify=CENTER,font=("goudly old style",15))
       ...
       #=====row1=======
        ...
        cmb_gender=ttk.Combobox(self.root,textvariable=self.var_gender,values=("Select","Mail","Female","Other"),state='readonly',justify=CENTER,font=("goudly old style",15))
        ...
        cmb_utype=ttk.Combobox(self.root,textvariable=self.var_utype,values=("Admin","Employee"),state='readonly',justify=CENTER,font=("goudly old style",15))
        ...
        emp_frame.place(x=0,y=350,relwidth=1,height=295)
